 ...
 */
export function searchURL (query, queryURLTemplate = 'https://www.google.com/search?q=') {
...
export function searchEngineQueryURL (query, queryURLTemplate) {
  ...
  return i < 0
    ...
    : `${queryURLTemplate.slice(0, i)}${encodedSearchQuery}${queryURLTemplate.slice(i + 2)}`;
}
